...
=======
    ...
    OLAPStatus append_like_condition(const TabletColumn& column, const std::string& pattern,
                                     int32_t field_index, int32_t bf_size, int32_t gram_size);
>>>>>>> 8b212b684... feat(clickhousech@5870585): add new ngram bloom filter index to speed up like query
